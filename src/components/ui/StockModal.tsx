  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-sm w-full p-6 z-10">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">Ingresa el nuevo stock para este insumo.</p>
        ...
        <div className="flex gap-2">
          ...
          <Button variant="primary" onClick={handleConfirm} className="flex-1" disabled={isSaving}>{isSaving ? 'Guardando...' : 'Aceptar'}</Button>
        </div>
      </div>
    </div>
  );
