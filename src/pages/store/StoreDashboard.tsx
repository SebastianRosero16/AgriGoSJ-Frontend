...
export const StoreDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-whatsapp-bg dark:text-gray-100">
      {/* Header */}
      <header className="bg-white shadow-sm dark:bg-whatsapp-header dark:border-b dark:border-whatsapp-header">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-primary-600 dark:text-whatsapp-light">
                {APP_INFO.NAME}
              </h1>
